...
const SaturdayYouth = () => {
  return(
    <div className="max-w-4xl ml-240 p-4">
            ...
            <div className="w-full md:w-3/5 p-8 flex flex-col justify-center space-y-6">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tight text-foreground">
                  Servicio del Sabado <span className="text-primary text-lg block md:inline font-medium">por la tarde</span>
                </h2>
              ...
              <div className="grid grid-cols-1 gap-4 py-2">
                <div className="flex items-center gap-3 text-sm text-foreground/80">
                  ...
                  <span>Todos los Sábados — 5:00 PM</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-foreground/80">
                  <div className="p-2 rounded-full bg-secondary/50">
